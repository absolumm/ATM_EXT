 ...
 *
 ************************************************************************************/
package com.generalbytes.batm.server.extensions.extra.spot9.sources.cd;

import com.generalbytes.batm.server.extensions.extra.spot9.sources.cd.*;
...
public class CryptodiggersRateSource implements IRateSource{
    ...
    public BigDecimal getExchangeRateLast(String cryptoCurrency, String fiatCurrency) {
        if (!(ICurrencies.BTC.equalsIgnoreCase(cryptoCurrency) || ICurrencies.SPX.equalsIgnoreCase(cryptoCurrency))) {
            return null;
        }
